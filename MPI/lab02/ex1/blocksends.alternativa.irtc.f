...
C ------------------------------------------------------------------------ 
     ...
     .     iargc, ierr, i, j
      character*10 arg1
      integer(8) itbegin, itend, irtc    ! used to measure elapsed time
...
C     time a ready send 
     ...
     .        itag(READY), icomm, ierr )
         itend = irtc ()
         print *, " Elapsed time for ready send = ", itend - itbegin,
     .        " nsec"
...
C     time a standard send 
     ...
     .        idest, itag(STANDARD), icomm, ierr )
         itend = irtc ()
         print *, " Elapsed time for standard send = ", itend - itbegin,
     .        " nsec"  
