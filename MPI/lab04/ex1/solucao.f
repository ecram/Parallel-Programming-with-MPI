...
!
      !  =====>  Put code here
      call MPI_GROUP_INCL(base_grp, ktr, list, newgrp(1), ierr)
      call MPI_COMM_CREATE(MPI_COMM_WORLD, newgrp(1), newcomm(1), ierr)
!
!  ================================================================
...
!
	 ...
	 list(ktr) = i
      ...
      call MPI_GROUP_INCL(base_grp, ktr, list, newgrp(2), ierr)
      call MPI_COMM_CREATE(MPI_COMM_WORLD, newgrp(2), newcomm(2), ierr)
!
      return
      end
